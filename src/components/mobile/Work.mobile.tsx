...
export default function WorkMobile() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[12%] left-[8%] right-[8%] h-[74svh] shadow-[0px_0px_24px_0px_rgba(255,255,255,0.09)] overflow-hidden rounded-sm transition-transform duration-1000 ease-out scale-105 group-[.is-visible]/work:scale-100">
      ...
      <div className="absolute top-[40%] left-1/2 -translate-x-1/2 z-10 text-center w-[82%] max-w-[360px] flex flex-col items-center gap-5 opacity-0 translate-y-6 transition-all duration-700 ease-out delay-200 group-[.is-visible]/work:opacity-100 group-[.is-visible]/work:translate-y-0">
        <p
